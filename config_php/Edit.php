 ...
 * pour pouvoir les redéclarer dans la class */
    ...
    public function editData(){
        ...
        $id = $_GET['edit'];
        $sql="UPDATE accommodation SET accommodation_title=:acc,
        description=:desc, image = :img_link, number_of_beds = :nb,
        number_of_bathrooms = :nbt , geographic_location = :gl , price = :price  WHERE id = $id ";
